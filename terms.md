...
일이공(이하 "앱")은 토플(TOEFL®) 시험 대비 영어 어휘 학습을 돕기 위해 독립적으로 개발된 iOS 애플리케이션입니다. 앱은 ETS와 무관합니다. 앱은 레벨(점수대)별 학습 콘텐츠를 제공하며, 레벨은 0-60, 61-80, 81-100, 101-120의 네 단계입니다. 각 레벨의 단어는 생물학, 천문학, 물리학처럼 학문 주제별 책으로 묶여 있고, 첫 주제 책은 무료로, 나머지 주제 책은 앱 내 구매(이용권)를 통해 이용할 수 있습니다.

### 2. 무료 이용 범위와 앱 내 구매

- **무료 범위:** 사용자가 선택한 레벨의 **첫 주제 책 한 권 전체(10챕터, 100단어)** 를 무료로 이용할 수 있습니다. 회독, 모름 단어 복습, 3초 퀴즈, 레벨 테스트 등 앱의 기능은 무료 범위 안에서 제한 없이 동작하며, 기능별 추가 결제는 없습니다.
- **유료 범위:** 두 번째 주제 책부터 이용하려면 이용권이 필요합니다. 이용권은 **연간 구독**, **월간 구독**, **평생 이용권** 중 하나이며, 어느 것이든 4개 레벨의 모든 주제 책이 전부 열립니다. 무료 체험 기간은 제공하지 않습니다.
...
- TOEFL®은 ETS(Educational Testing Service)의 등록 상표입니다. 본 앱은 "시험 대비"라는 서비스의 목적을 설명하기 위한 서술적 용도로만 상표를 언급하며, ETS와 무관하고 ETS의 제휴나 보증, 승인을 받지 않았습니다.
...
- 문의: [이메일 보내기](mailto:forgelab.aitech@gmail.com?subject=%5BOne20%5D%20%EC%9D%B4%EC%9A%A9%EC%95%BD%EA%B4%80%20%EB%AC%B8%EC%9D%98)
...
One20 ("the App") is an independently developed iOS application that helps users study English vocabulary in preparation for the TOEFL® test. The App is not affiliated with ETS. The App provides study content organized by level (score band), and there are four levels: 0-60, 61-80, 81-100 and 101-120. Within each level the words are grouped into subject books such as Biology, Astronomy and Physics; the first subject book is free, and the remaining subject books can be unlocked through an in-app purchase (a pass).
...
- TOEFL® is a registered trademark of ETS (Educational Testing Service). The mark is used solely in a descriptive (nominative) manner to indicate the purpose of the App, which is test preparation. This App is not affiliated with, endorsed, or approved by ETS.
...
- Contact: [Send us an email](mailto:forgelab.aitech@gmail.com?subject=%5BOne20%5D%20Terms%20inquiry)
